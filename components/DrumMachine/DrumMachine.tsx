...
import { playDrum, TRACKS, type Track } from "./drumSynth";
...
const DrumMachine = () => {
  ...
  const hit = useCallback((kit: Track) => {
    playDrum(kit.type, volumeRef.current / 100);
    setLabel(kit.name);
    ...
    <div className="dm-page">
      ...
      <main className="dm-main">
        ...
        <div className="dm-device">
          ...
          <div className="dm-volume">
            <span className="dm-volume-label">Volume</span>
            <input
